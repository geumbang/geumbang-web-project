...
public class PriceService implements IPriceService {
	...
	public List<Object> goldPriceResult() {
		...
		double gold24Buy = goldBuy / 31.1035 * 3.75 * exRate;
		double gold24Sell = goldSell / 31.1035 * 3.75 * exRate;
		double prevGold24Buy = prevGoldBuy / 31.1035 * 3.75 * exRate;
		double prevGold24Sell = prevGoldSell / 31.1035 * 3.75 * exRate;
		double gold24BuyChange = gold24Buy - prevGold24Buy;
		double gold24SellChange = gold24Sell - prevGold24Sell;
		double gold18Buy = goldBuy / 31.1035 * 3.75 * 0.825 * exRate;
		double gold18Sell = goldSell / 31.1035 * 3.75 * 0.825 * exRate;
		double prevGold18Buy = prevGoldBuy / 31.1035 * 3.75 * 0.825 * exRate;
		double prevGold18Sell = prevGoldSell / 31.1035 * 3.75 * 0.825 * exRate;
		double gold18BuyChange = gold18Buy - prevGold18Buy;
		double gold18SellChange = gold18Sell - prevGold18Sell;
		double gold14Buy = goldBuy / 31.1035 * 3.75 * 0.6435 * exRate;
		double gold14Sell = goldSell / 31.1035 * 3.75 * 0.6435 * exRate;
		double prevGold14Buy = prevGoldBuy / 31.1035 * 3.75 * 0.6435 * exRate;
		double prevGold14Sell = prevGoldSell / 31.1035 * 3.75 * 0.6435 * exRate;
...
//
	...
	public Price selectGoldPrice(int g_id) {
		// TODO Auto-generated method stub
		Price selectGoldPrice = pDao.selectPrice(g_id);
